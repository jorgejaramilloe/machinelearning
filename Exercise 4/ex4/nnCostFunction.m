...
delta_var1 = zeros(size(Theta1));
delta_var2 = zeros(size(Theta2));
...
for t = 1:m
	...
	delta_var1 = delta_var1 + delta_2(2:end)'*A1;
	delta_var2 = delta_var2 + delta_3'*A2;
end;

Theta1_grad = delta_var1/m;
Theta2_grad = delta_var2/m;
